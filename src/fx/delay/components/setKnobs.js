...
export function setKnobs(id) {
    ...
    if (project.mode === 'pattern') {
        ...
        mainInterface.statusRing(`fx.Par1.LightRing.${channelType}.${insertNumber}`, 'Plus', this.knobValueDelayTime);
        mainInterface.statusRing(`fx.Par2.LightRing.${channelType}.${insertNumber}`, 'Plus', this.knobValueFeedback);
        mainInterface.statusRing(`fx.Par3.LightRing.${channelType}.${insertNumber}`, 'Plus', this.knobValueWet);
        rotate(`fx.Par1.RotateThis.${channelType}.${insertNumber}`, svg, this.knobValueDelayTime);
        rotate(`fx.Par2.RotateThis.${channelType}.${insertNumber}`, svg, this.knobValueFeedback);
        ...
        mainInterface.statusRing(`fx.Par1.LightRing.${channelType}.${channel}.${subChannel}.${insertNumber}`, 'Plus', this.knobValueDelayTime);
        mainInterface.statusRing(`fx.Par2.LightRing.${channelType}.${channel}.${subChannel}.${insertNumber}`, 'Plus', this.knobValueFeedback);
        mainInterface.statusRing(`fx.Par3.LightRing.${channelType}.${channel}.${subChannel}.${insertNumber}`, 'Plus', this.knobValueWet);
        rotate(`fx.Par1.RotateThis.${channelType}.${channel}.${subChannel}.${insertNumber}`, svg, this.knobValueDelayTime);
        rotate(`fx.Par2.RotateThis.${channelType}.${channel}.${subChannel}.${insertNumber}`, svg, this.knobValueFeedback);
